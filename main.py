...
parser.add_argument('--pretrain_G_epoch', dest='pretrain_G_epoch', default=1)
parser.add_argument('--pretrain_D_epoch', dest='pretrain_D_epoch', default=1)
parser.add_argument('--pretrain_C_epoch', dest='pretrain_C_epoch', default=1)
parser.add_argument('--train_epoch', dest='train_epoch', default=1)
...
parser.add_argument('--pretrain_G', dest='pretrain_G', type=bool, default=True)
parser.add_argument('--pretrain_D', dest='pretrain_D', type=bool, default=True)
parser.add_argument('--pretrain_C', dest='pretrain_C', type=bool, default=True)
parser.add_argument('--train', dest='train', type=bool, default=True)
parser.add_argument('--test', dest='test', type=bool, default=True)
parser.add_argument('--model_path', dest='model_path', default='model/best_model.pth')
